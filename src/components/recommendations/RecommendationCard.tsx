...
export default function RecommendationCard({ recommendation: rec }: RecommendationCardProps) {
  const { title, description, city, imageUrl, tags, type, actionUrl } = rec;
      ...
      <div className="p-3 flex flex-col flex-1">
        ...
        {actionUrl && (
          <a
            ...
            className="mt-3 w-full text-center bg-teal-600 hover:bg-teal-700 text-white text-xs font-semibold py-2 rounded-xl transition-colors"
          >
            Explore →
          </a>
        )}
