...
export default function DayCard({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-4">
      {/* 头部图片区域 */}
      <div className="relative h-48 w-full bg-gradient-to-br from-emerald-100 to-blue-100">
        {imageUrl ? (
          <Image
            src={imageUrl}
            alt={title}
      ...
      <div className="p-4">
          ...
          {activities.map((activity, index) => (
            ...
            >
              ...
              <div className="flex-1 pb-4">
                ...
                {activity.cost && (
                  <span className="inline-block mt-2 px-2 py-1 bg-emerald-50 text-emerald-700 text-xs rounded-full">
                    💰 {activity.cost}
                  </span>
                )}
              </div>
        ...
        {activities.length > 2 && (
          <button
            ...
            className="w-full mt-2 py-2 text-sm text-emerald-600 font-medium hover:bg-emerald-50 rounded-lg transition-colors"
          >
        ...
        <div className="mt-4 pt-4 border-t border-gray-100 flex items-center justify-between">
          <div className="text-sm">
            ...
            <span className="text-emerald-600 font-bold">💰{totalCost}</span>
            {steps && (
