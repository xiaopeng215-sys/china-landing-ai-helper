          ...
          <div className="space-y-3">
            ...
            <div className="border-t pt-2">
              ...
              <button
                ...
                className="w-full py-1 px-2 text-xs bg-teal-600 text-white rounded hover:bg-teal-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
              >
                {isSyncing ? '同步中...' : '立即同步'}
              </button>
            </div>
