      ...
      <div className="grid grid-cols-2 gap-3">
        {destinations.map(city => (
          <button
            ...
            className="p-4 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl text-left rtl:text-right active:scale-[0.98] transition-transform border border-gray-200 hover:border-teal-400 touch-manipulation"
          >
