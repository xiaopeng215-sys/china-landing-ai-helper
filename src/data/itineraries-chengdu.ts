...
export const chengdu3Days: ItineraryRoute = {
  ...
  days: 3,
  title: '成都 3 天美食之旅',
  titleEn: 'Chengdu 3-Day Food & Culture Tour',
  subtitle: '川菜天堂 · 熊猫基地 · 茶馆文化',
  subtitleEn: 'Sichuan Cuisine · Panda Base · Teahouse Culture',
  theme: ['美食', '熊猫', '文化', '休闲'],
  themeEn: ['Food', 'Pandas', 'Culture', 'Leisure'],
  budget: '¥2500',
  ...
  descriptionEn: 'Land of Abundance and UNESCO Creative City of Gastronomy — see pandas, eat hotpot, and embrace the Chengdu slow-life philosophy.',
  practicalInfo: {
  ...
  dayPlans: [
    {
      ...
      titleEn: 'Panda Day',
      theme: '大熊猫 · 宽窄巷子',
      themeEn: 'Giant Pandas · Wide & Narrow Alleys',
      activities: [
      ...
      tipsEn: ['Go to the Panda Base early; take the direct shuttle back from the gate', 'Mild spice is the minimum for Chengdu hotpot — visitors should avoid extra-spicy', 'Cool down after hotpot with a bowl of ice jelly (bingfen)']
    },
    {
      day: 2,
      title: '文化探索日',
      titleEn: 'Culture Exploration Day',
      theme: '武侯祠 · 锦里 · 杜甫草堂',
      themeEn: 'Wuhou Shrine · Jinli Street · Du Fu Cottage',
      activities: [
      ...
      tipsEn: ['Jinli is right next to Wuhou Shrine but looks better at night — adjust the order', 'Du Fu Cottage is farther away — best to dedicate a separate half-day', "Chunxi Road is Chengdu's fashion hub — great for seeing the trendy side of the city"]
    },
    {
      day: 3,
      title: '休闲体验 + 返程',
      titleEn: 'Leisure & Departure',
      theme: '都江堰 · 采耳 · 返程',
      themeEn: 'Dujiangyan · Ear Cleaning · Departure',
      activities: [
      ...
      tipsEn: ['Skip Dujiangyan? Swap for Mount Qingcheng (Taoist mountain) — allow a full day', "Best teahouse experience: Heming Teahouse in People's Park", 'Before leaving, pick up Zhangfei Beef or Pixian Doubanjiang as souvenirs']
    }
  ]
};
