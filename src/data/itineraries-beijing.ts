...
export const beijing5Days: ItineraryRoute = {
  ...
  days: 5,
  title: '北京 5 天文化之旅',
  titleEn: 'Beijing 5-Day Cultural Journey',
  subtitle: '皇城古迹 · 京味美食 · 胡同文化',
  subtitleEn: 'Imperial Heritage · Beijing Cuisine · Hutong Culture',
  theme: ['历史', '文化', '美食', '胡同'],
  themeEn: ['History', 'Culture', 'Food', 'Hutong'],
  budget: '¥5000',
  bestSeason: '4 月 -6 月 / 9 月 -10 月',
  bestSeasonEn: 'Apr–Jun / Sep–Oct',
  highlights: ['故宫', '长城', '胡同骑游', '天坛', '颐和园'],
  highlightsEn: ['Forbidden City', 'Great Wall', 'Hutong Cycling', 'Temple of Heaven', 'Summer Palace'],
  description: '从紫禁城到八达岭，从胡同深处到后海酒吧街，全方位感受中国政治文化中心 3000 年历史。',
  descriptionEn: 'From the Forbidden City to Badaling, from deep hutong alleys to Houhai bar street — experience 3,000 years of China\'s political and cultural heart.',
  practicalInfo: {
  ...
  dayPlans: [
    {
      day: 1,
      title: '中轴线探索',
      titleEn: 'Central Axis Exploration',
      theme: '天安门 · 故宫 · 国家博物馆',
      themeEn: 'Tiananmen · Forbidden City · National Museum',
      activities: [
      ...
      tipsEn: ['Plan a full day for Tiananmen + Forbidden City; arrive early to beat the crowds', 'No restaurants inside the Forbidden City — bring snacks or eat after you exit', 'Bring your original ID; security checks are strict']
    },
    {
      day: 2,
      title: '长城一日游',
      ...
      theme: '八达岭 · 户外挑战',
      themeEn: 'Badaling · Outdoor Challenge',
      activities: [
      ...
      tipsEn: ['Transit: S2 train from Huoying Metro to Badaling; return on Bus 919 Express to Deshengmen', 'Limited energy? Take the cable car up to North Tower 8, then walk down', 'Spring and autumn winds are strong on the Wall — bring a jacket']
    },
    {
      day: 3,
      title: '胡同骑游日',
      titleEn: 'Hutong Cycling Day',
      theme: '胡同 · 四合院 · 老北京',
      themeEn: 'Hutong · Courtyard Houses · Old Beijing',
      activities: [
      ...
      tipsEn: ['The hutong cycling loop is about 5–6 km — a shared bike is plenty', 'Nanluoguxiang and Shichahai are close — you can walk between them', 'Some courtyards are private residences — do not enter without permission']
    },
    {
      day: 4,
      title: '皇家园林之旅',
      titleEn: 'Imperial Gardens Day',
      theme: '天坛 · 颐和园 · 北大清华',
      themeEn: 'Temple of Heaven · Summer Palace · PKU & THU',
      activities: [
      ...
      tipsEn: ['Summer Palace is huge — buy the combo ticket or many attractions will be locked', 'Temple of Heaven + Summer Palace in one day is tiring — pace yourself', 'PKU and Tsinghua now require advance reservation to enter']
    },
    {
      day: 5,
      title: '现代北京 + 返程',
      titleEn: 'Modern Beijing & Departure',
      theme: '798 艺术区 · 返程',
      themeEn: '798 Art District · Departure',
      activities: [
      ...
      tipsEn: ['798 is great for picking up creative souvenirs to bring home', 'If your flight is in the evening, store luggage at the hotel and travel light', 'Beijing traffic is brutal — leave plenty of time to reach the airport']
    }
  ]
};
