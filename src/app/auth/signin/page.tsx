...
export default function SignInPage() {
  ...
  const handleGoogleSignIn = async () => {
    setError(t('AuthPage.googleComingSoon', 'Google sign-in is being configured.'));
  };

  const handleFacebookSignIn = async () => {
    setError(t('AuthPage.facebookComingSoon', 'Facebook sign-in is being configured.'));
  };

  const handleOpenAISignIn = async () => {
    setError(t('AuthPage.openaiComingSoon', 'OpenAI sign-in is being configured.'));
  };
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
          ...
          <div className="space-y-3 mb-6">
            ...
            >
              ...
              {t('AuthPage.signInWithGoogle', 'Sign in with Google')}
            </button>
            ...
            >
              ...
              {t('AuthPage.signInWithFacebook', 'Sign in with Facebook')}
            </button>
            ...
            <button
              ...
              className="w-full py-3 bg-white border border-gray-200 rounded-xl font-semibold text-[#484848] hover:bg-gray-50 transition-all duration-200 flex items-center justify-center gap-3 disabled:opacity-50"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="#412991" aria-hidden="true">
                <path d="M22.281 9.821a5.984 5.984 0 0 0-.516-3.909 6.046 6.046 0 0 0-6.509-2.9A6.065 6.065 0 0 0 4.977 4.18a5.983 5.983 0 0 0-3.993 2.9 6.046 6.046 0 0 0 .745 7.097 5.98 5.98 0 0 0 .51 3.91 6.051 6.051 0 0 0 6.515 2.9 5.984 5.984 0 0 0 3.988-2.91 6.056 6.056 0 0 0 10.032-1.174 5.987 5.987 0 0 0-.494-7.082z"/>
              </svg>
              {t('AuthPage.signInWithOpenAI', 'Sign in with OpenAI')}
            </button>
          </div>
