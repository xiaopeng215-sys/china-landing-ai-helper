      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
          ...
          <div className="space-y-3 mb-6">
            <div
              className="w-full py-3 bg-gray-50 border border-gray-200 rounded-xl font-semibold text-gray-400 cursor-not-allowed flex items-center justify-center gap-3 relative"
              aria-disabled="true"
              title={t('AuthPage.googleComingSoon', 'Google sign-in is being configured.')}
            >
              <svg className="w-5 h-5 opacity-40" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <span className="absolute right-3 text-xs bg-gray-200 text-gray-500 px-2 py-0.5 rounded-full">
                {t('AuthPage.comingSoon', 'Coming Soon')}
              </span>
            </div>
            ...
            <div
              className="w-full py-3 bg-gray-50 border border-gray-200 rounded-xl font-semibold text-gray-400 cursor-not-allowed flex items-center justify-center gap-3 relative"
              aria-disabled="true"
              title={t('AuthPage.facebookComingSoon', 'Facebook sign-in is being configured.')}
            >
              <svg className="w-5 h-5 opacity-40" viewBox="0 0 24 24" fill="#1877F2" aria-hidden="true">
